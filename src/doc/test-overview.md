...
| 01.20| Standard invoice with 2 lines, 1 invoice note, 1 tax category, 1 payment means code 42, delivery location, delivery party, delivery date, payment terms, invoice period for position, due date | 389 | no | :white_check_mark: | :white_check_mark: |

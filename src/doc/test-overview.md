...
| 02.05| Standard invoice with more than 20 lines, 2 tax categories, 1 payment means code 58, due date, contract reference, additional document binary object, exemption reason, allowance, charge, end point id | 380 | no | :white_check_mark: | :white_check_mark: |

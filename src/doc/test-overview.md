...
This table gives an overview of the content of comprehensive test instances for the technical cases. As some elements contradict each other, various test files are necessary to cover all elements contained in the semantic model of CIUS XRechnung. The table indicates the most significant differences and which file covers which of the non-common elements.
